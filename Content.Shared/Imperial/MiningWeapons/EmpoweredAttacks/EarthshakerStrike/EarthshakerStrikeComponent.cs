...
namespace Content.Shared.Imperial.MiningWeapons.EmpoweredAttacks.EarthshakerStrike;
...
public sealed partial class EarthshakerStrikeComponent : Component
{
    ...
    public SoundSpecifier CompletedSound = new SoundPathSpecifier("/Audio/Imperial/MiningWeapons/EmpoweredAttacks/EarthshakerStrike/earthshaker_strike.ogg");
