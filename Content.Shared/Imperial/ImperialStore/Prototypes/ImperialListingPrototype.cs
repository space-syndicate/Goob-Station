...
public partial class ImperialListingData : IEquatable<ImperialListingData>, ICloneable
{
    [ViewVariables]
    [IdDataField]
    ...
    /// </summary>
    [DataField]
    public List<ProtoId<ImperialStoreCategoryPrototype>> Categories = new();

    /// <summary>
    /// The cost of the listing. String represents the currency type while the FixedPoint2 represents the amount of that currency.
    /// </summary>
    [DataField]
    public Dictionary<ProtoId<ImperialCurrencyPrototype>, FixedPoint2> Cost = new();
    ...
    public List<ImperialListingCondition>? Conditions;
    ...
    /// </summary>
    [DataField]
    public List<ProtoId<ImperialListingPrototype>?> ProductUpgradeId = new();

    /// <summary>
    /// Shows how much the action level will increase when purchasing this listing
    /// </summary>
    [DataField]
    public int ActionLevelUp = 1;
    ...
    public bool Equals(ImperialListingData? listing)
    {
        if (listing == null)
            return false;
        ...
        if (Priority != listing.Priority ||
            ...
            ActionLevelUp != listing.ActionLevelUp ||
        ...
        if (Cost.Count != listing.Cost.Count && Cost.Except(listing.Cost).Any())
            return false;
    ...
    public object Clone()
    {
        return new ImperialListingData
        {
            ID = ID,
            Name = Name,
