...
public sealed partial class ImperialCurrencyPrototype : IPrototype
{
    ...
    /// <summary>
    /// Color of <see cref="DisplayName"/>
    /// </summary>
    [DataField("displayNameColor")]
    public Color DisplayNameColor { get; private set; } = Color.White;

    /// <summary>
    /// Short currency name displayed in the button if there is no space in it
    /// </summary>
    [DataField]
    public string? ShortName;

    /// <summary>
    /// If true, then it is not displayed in the purchase button of the listing
    /// </summary>
    [DataField]
    public bool IgnoreInPurchaseButton = false;
    ...
    /// <summary>
    /// Whether to draw currency separately from the main group
    /// </summary>
    [DataField("drawSeparately")]
    public bool DrawSeparately = false;
