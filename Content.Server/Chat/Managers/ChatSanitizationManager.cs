...
public sealed class ChatSanitizationManager : IChatSanitizationManager
{
    ...
    [
        ...
        Entry("0_0", "chatsan-wide-eyed"), // cyrillic о
        Entry("О_О", "chatsan-wide-eyed"), // cyrillic о
        Entry("о_о", "chatsan-wide-eyed"), // cyrillic о
        Entry("о_0", "chatsan-wide-eyed"), // cyrillic о
        ...
        Entry("!см", "chatsan-laughs"),
        Entry("!св", "chatsan-whistle"),
        Entry("!в", "chatsan-sighs"),
        Entry("!х", "chatsan-claps"),
        Entry("!п", "chatsan-cries"),
