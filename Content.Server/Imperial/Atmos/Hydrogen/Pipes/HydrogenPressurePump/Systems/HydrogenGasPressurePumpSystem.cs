...
using Content.Shared.Imperial.Atmos.EntitySystems;
...
[UsedImplicitly]
public sealed class HydrogenGasPressurePumpSystem : SharedHydrogenGasPressurePumpSystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<HydrogenGasPressurePumpComponent, AtmosDeviceUpdateEvent>(OnPumpUpdated);
    }

    private void OnPumpUpdated(Entity<HydrogenGasPressurePumpComponent> ent, ref AtmosDeviceUpdateEvent args)
    {
        if (!ent.Comp.Enabled
