...
# CorvaxGoob Edit
research-console-unlock-technology-radio-broadcast = [color=DarkOrchid]Unlocked [bold]{$technology}[/bold] for [bold]{$amount}[/bold] research by [bold]{$approver}[/bold].[/color]
