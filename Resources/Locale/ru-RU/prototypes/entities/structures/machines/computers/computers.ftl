...
ent-ComputerNukieDelivery = консоль доставки синдиката
    .desc = Компьютер, способный работать с блюспейс пространством. Печатная плата интегрирована в корпус и не может быть восстановлена ​​при разборке.
