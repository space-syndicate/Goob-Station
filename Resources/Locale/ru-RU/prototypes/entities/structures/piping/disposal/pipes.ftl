...
ent-DisposalBend = изгиб утилизационной трубы
    ...
    .suffix = { "" }
ent-DisposalSignalRouter = утилизационный сигнальный маршрутизатор
    .desc = Трехсторонний маршрутизатор, управляемый сигналом.
ent-DisposalSignalRouterFlipped = утилизационный сигнальный маршрутизатор
    .desc = Трехсторонний маршрутизатор, управляемый сигналом.
...
ent-DisposalSignaller = утилизационный триггер
    .desc = Труба, создающая сигнал при прохождении через неё предмета.
    .suffix = { "" }
