...
ent-ToolboxArtisticFilled = { ent-ToolboxArtistic }
    ...
    .suffix = Заполненный
ent-FoolboxFilled = ящик для дураков
    .desc = Набор инструментов для дураков, набитый клоунским инвентарем.
    .suffix = Заполненный
ent-Foolbox = { ent-FoolboxFilled }
    .desc = { ent-FoolboxFilled.desc }
