...
ent-VendingMachineRestockCostumes = набор пополнения ТеатроШкаф
    ...
    .suffix = { "" }
ent-VendingMachineRestockDinnerware = набор пополнения Кухонные инструменты
    .desc = На этой кухне всегда жарко! Поместите в слот для пополнения Кухонных инструментов чтобы начать.
    .suffix = { "" }
