...
ent-XenoBasherGlass = стакан ксеноубийцы
    .desc = { ent-DrinkBase.desc }
ent-DrinkEmpress75 = стакан императрицы 75
    .desc = Более изысканный вариант мимозы. Именно такой, какой Мария-Антуанетта, возможно, любила до революции.
ent-DrinkVampiroGlass = стакан вампиро
    .desc = Популярно в Мексике и Трансильвании.
ent-DrinkTortugaGlass = стакан тортуги
    .desc = Идеально подходит для пиратов, выбранных в качестве водителя. Йарр!
ent-DrinkMayojito = стакан майожито
    .desc = Оскорбление бога и человека. Не пейте это.
ent-DrinkTheSunAlsoRises = стакан солнце тоже встает
    .desc = Крепкий коктейль, смешанный в мутную смесь. Тайный фаворит измученных авторов.
ent-DrinkMimosa = стакан мимозы
    .desc = Идеально подходит для оживленного завтрака с подругами.
ent-DrinkEspressoMartini = стакан эспрессо мартини
    .desc = Чтобы разбудить и успокоить вас. Украшен кофейными зернами и ледяным напитком.
ent-DrinkCaipirinha = стакан кайпиринья
    .desc = Фирменный напиток Сан-Паулу прямиком из старой Бразилии.
ent-DrinkDaiquiri = стакан дайкири
    .desc = Классический ромовый коктейль, который остается популярным даже в холодных уголках космоса.
