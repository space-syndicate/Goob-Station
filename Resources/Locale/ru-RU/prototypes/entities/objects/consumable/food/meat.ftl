...
ent-FoodMeatGoliath = сырое мясо голиафа
    ...
    .suffix = { "" }
ent-FoodHivelordPhantomor = кость фантомора
    .desc = Кость, оставшаяся после распада фантомора. На удивление лёгкая, будто пропитанная остаточной энергией телепортаций.
