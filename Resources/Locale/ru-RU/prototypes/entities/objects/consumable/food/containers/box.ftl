...
ent-FoodBoxDonkpocketStonk = коробка стонк-покетов с ограниченным тиражом
    .desc = Инструкции: Разогрейте в микроволновой печи. Продукт остынет, если его не съесть в течение семи минут.
ent-HappyHonkNukieSnacks = обед Нюка Робаст
    .desc = Подозрительный обед с потенциально взрывоопасным сюрпризом.
    .suffix = небезопасная игрушка, Закуски
ent-BoxSecglasses = коробка солнцезащитных очков
    .desc = Коробка с очками СБ.
ent-BoxSunglasses = коробка солнцезащитных очков
    .desc = Коробка классных солнцезащитных очков с защитой от вспышек.
ent-BoxDetonator = коробка детонаторов
    .desc = Коробка взрывчатых детонаторов и триггеров.
ent-BoxStamps = коробка штампов
    .desc = Коробка для хранения штампов.
ent-BoxWarmLightbulb = коробка тёплых лампочек
    .desc = Внутренняя форма этой коробки такова, что в неё помещаются только трубки и лампочки.
...
ent-BoxLighttubeColorfulMixed = коробка разноцветных ламп-трубок
    .desc = Внутренняя форма этой коробки такова, что в неё помещаются только трубки и лампочки.
ent-BoxSurvivalMilitaryDoubleNitrogen = маленькая картонная коробка
    .desc = Это коробка с базовым внутренним содержимым. На этой коробке указано, что она предназначена для хранения двойного баллона увеличенной емкости.
ent-BoxSurvivalMilitaryDouble = маленькая картонная коробка
    .desc = Это коробка с базовым внутренним содержимым. На этой коробке указано, что она предназначена для хранения двойного баллона увеличенной емкости.
