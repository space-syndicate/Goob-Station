...
ent-PaperCargoInvoice = грузовая накладная
    ...
    .suffix = { "" }
ent-PaperCargoBountyManifest = манифест задачи
    .desc = Бумажная этикетка, обозначающая, что ящик содержит то что нужно для цели. Продажа ящика с этой этикеткой приведет к выполнению задачи.
    .suffix = { "" }
...
ent-CyberPen = ручка Cybersun
    ...
    .suffix = { "" }
ent-FakeCyberPen = ручка Sybercun
    .desc = Высокотехнологичная ручка прямо из юридического отдела Cybersun, для письма... Погоди, это просто дешевая подделка, твою ж!
    .suffix = { "" }
...
ent-PaperScrap = бумажные отходы
