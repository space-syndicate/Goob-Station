...
ent-WeaponTaserSuper = элитный тазер
    .desc = Низкоёмкостный энергетический тазер, используемый элитными отрядами безопасности для вырубания даже самых крепких целей.
    .suffix = Адмеме
...
ent-WeaponLaserSvalinn = лазерный пистолет Свалинна
...
ent-WeaponDisablerSMG = ПП станнер
    .desc = Передовое оружие, которое истощает органические цели, ослабляя его до тех пор, пока он не свалится.
