...
ent-PlushieExperiment = игрушка для экспериментов
...
ent-WeaponStickyHand = липкая рука
    .desc = Они говорят, что ты перегибаешь палку. Они говорят, что это преувеличение. Ты им всем покажешь, и ты им это прилепишь.
