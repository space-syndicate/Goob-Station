...
ent-ClothingNeckCloakCentcom = плащ Центрального Командования
    .desc = Элитный зеленый плащ с красивой золотой отделкой, сшитый специально для Главкома. Он настолько тяжелый, что золотая отделка вероятно настоящая.
ent-ClothingNeckCloakVoid = пустотный плащ
    .desc = Плащ тьмы. Для тех, кто перешел на темную сторону силы.
ent-ClothingNeckCloakSalvagerSupreme = плащ высшего утилизатора
    .desc = Его носят самые опытные утилизаторы, те, кто покорил космос и создавал астероиды, где добываются полезные ископаемые, своей вотчиной. Они ведь не раздают такие вещи просто так, понимаешь?
ent-ClothingNeckCloakAroace = плащ аэропилота
    .desc = Плащ, вручаемый лучшим пилотам NanoTrasen на планетах с пригодной для жизни атмосферой.
