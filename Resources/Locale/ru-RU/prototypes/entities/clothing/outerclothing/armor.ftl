...
ent-WiredApronBase = бронированный фартук
    .desc = Фартук, усиленный кабелями. Выглядит неготовым.
ent-SteelApronBase = стальной фартук
    .desc = Фартук со стальной бронёй, удерживаемой кабелями. Выглядит так, что развалится при первом же ударе.
ent-WeldedSteelApronBase = сваренный стальной фартук
    .desc = Фартук со стальной бронёй, приваренной к основе и закреплённой кабелями. Всё ещё не готов.
ent-ClothingOuterArmorScrap = броня из лома
    .desc = Блестящие пластинки, любимые пассажирами. Давай кошелёк, или ты труп.
