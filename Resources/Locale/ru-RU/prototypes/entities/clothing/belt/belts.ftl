...
ent-ClothingBeltMilitaryWebbingMed = армейская РПС медика
    ...
    .suffix = { "" }
ent-ClothingBeltMilitaryWebbingERT = армейская РПС ОБР
    .desc = Ременно-поясная система тактических ремней, которые носят отряды быстрого реагирования.
    .suffix = { "" }
...
ent-ClothingBeltMedicalEMT = пояс парамедика
    .desc = идеально подходит для хранения различного снаряжения для оказания неотложной медицинской помощи.
