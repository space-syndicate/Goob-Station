...
ent-ClothingShoesBootsMagERT = магнитные сапоги ОБР
    .desc = Усовершенствованные магнитные ботинки, используемые отрядами быстрого реагирования компании NanoTrasen, обладают мощным магнитным притяжением и встроенными двигателями.
    .suffix = { "" }
