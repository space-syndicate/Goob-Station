...
ent-WiredBucketBase = ведро с проводами
    .desc = Ведро с прикрученными кабелями, которые служат ремешком для подбородка. Выглядит не слишком надёжно.

ent-SlicedBucketBase = ведро с дыркой
    .desc = Ведро с узкой прорезью для обзора. Сомнительная защита, но хоть видно, куда идёшь.

ent-SteelBucketBase = усиленное ведро
    .desc = Ведро с приваренными стальными листами. Нужно лучше подогнать форму, чтобы носить без мучений.

ent-ClothingHeadHelmetScrap = шлем из лома
    .desc = Слепленный из ведра, стали и кабелей шлем. Тесный, грубый и устрашающий.
