...
ent-ClothingBackpackDuffelSyndicateFilledCarbine = набор "М-90gl"
    ...
    .suffix = { "" }
ent-ClothingBackpackDuffelSyndicateFilledMedicine = набор химикатов
    .desc = Большая вещевая сумка, содержащая необходимые лекарственные препараты.
    .suffix = { "" }
...
ent-ClothingBackpackDuffelSyndicateAmmoFilled = набор боеприпасов
    .desc = Перезаряжаю! Содержит 4 магазина для C-20r, 2 магазина для AKM, 5 барабанов для Бульдог, 3 магазина для Estoc DMR и 2 коробки с патронами для L6 SAW.
