...
reagent-name-caffeine = кофеин
reagent-desc-caffeine = В малых дозах повышает скорость передвижения, но вызывает дрожь, боль в груди и замедление движений при избытке в кровотоке.
reagent-name-junk-food = фастфуд
reagent-desc-junk-food = Делает вас вялым, если съесть слишком много.
