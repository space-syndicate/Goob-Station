...
blob-chem-reactivespines-info =
    Реактивные шипы
    Наносит 8 единиц урона ушибами, 8 урона порезами, 8 урона уколами и 150 структурного урона.
blob-chem-blazingoil-info =
    Пылающее масло
    Наносит 15 урона ожогами и 150 структурного урона, поджигает цель.
    Делает уязвимым к воде.
blob-chem-regenerativemateria-info =
    Регенеративная материя
    Наносит 15 урона ядами и 120 структурного урона.
    Ядро блоба восстанавливает здоровье в 10 раз быстрее, ресурсные блобы генерируют на 1 ресурс больше.
blob-chem-explosivelattice-info =
    Взрывчатая решетка
    Наносит 5 урона от ожогов, 150 структурного урона и взрывает цель, нанося 10 грубого урона.
    Споры взрываются при смерти.
    Вы получаете иммунитет к взрывам.
    Получаете на 50% больше урона от ожогов и электричества.
blob-chem-electromagneticweb-info =
    Электромагнитная паутина
    Наносит 18 урона током и 150 структурного урона, 20% шанс вызвать импульс ЭМИ при атаке.
