...
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на сандевистан — синтетический орган, который значительно увеличивает скорость пользователя ценой его выносливости. В отличие от обычного аналога, этот, по-видимому, замедляет время рядом с вами. Требует слишком тонкой настройки, чтобы человек мог её выполнить, поэтому поставляется с одноразовой автооперацией для установки.
