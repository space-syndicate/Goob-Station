...
uplink-autosurgeon-statveka-sandevistan-name = Автооперация (сандевистан СТАТВЕКА)
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на сандевистан «Статвека» — синтетический орган, который значительно увеличивает скорость пользователя ценой его выносливости. В отличие от обычного сандевистана, этот, судя по всему, замедляет время рядом с пользователем. Требует слишком тонкой настройки, чтобы человек мог её выполнить, поэтому поставляется с одноразовой автооперацией для установки.
uplink-davids-jacket-name = Куртка на грани
uplink-davids-jacket-desc = Куртка для тех, кто желает лучшее контролировать сандевистан. Цена низкая, ибо снята с трупа, который перешел грань...
