...
uplink-autosurgeon-statveka-sandevistan-name = Автооперация (сандевистан MI13)
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на сандевистан MI13 — синтетический орган, который значительно увеличивает скорость и рефлексы пользователя ценой его выносливости. В отличие от обычной версии, этот замедляет время рядом с пользователем. Поставляется с одноразовой автооперацией для установки.
uplink-sandevistan-bundle-name = Набор сандевистан
uplink-sandevistan-bundle-desc = Автооперация в комплекте с курткой бегущего на грани. Не живите чужой мечтой!
uplink-statveka-sandevistan-bundle-name = Набор сандевистан MI13
uplink-statveka-sandevistan-bundle-desc = Автооперация в комплекте с курткой бегущего на грани. Не живите чужой мечтой!
ent-UplinkSandevistanBundle = Набор сандевистан
    .desc = Автооперация в комплекте с курткой на грани. Не живите чужой мечтой!
ent-UplinkStatvekaSandevistanBundle = Набор сандевистан MI13
    .desc = Автооперация в комплекте с курткой бегущего на грани. Не живите чужой мечтой!
