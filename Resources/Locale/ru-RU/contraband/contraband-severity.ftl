...
contraband-examine-text-Restricted = [color=yellow]Этот предмет ограничен для использования в определённых отделах.[/color]
...
contraband-examine-text-Magical = [color=#b337b3]Этот предмет является строго запрещённой магической контрабандой![/color]
...
contraband-examinable-verb-text = Правовой статус
contraband-examinable-verb-message = Проверить правовой статус предмета.
