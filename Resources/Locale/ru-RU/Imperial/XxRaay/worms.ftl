ent-MobWormTier1 = Глист
    .desc = Маленький кроваво-красный червяк, нервно дёргающийся у самых ног. Пролезает под шлюзами, как мышь.
...
ent-MobWormTier3 = Кровавый червь
    .desc = Огромный кровавый червь в плотных пластинах, движущийся медленно и неотвратимо.
