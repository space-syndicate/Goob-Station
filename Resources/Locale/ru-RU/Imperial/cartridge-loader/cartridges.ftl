...
nano-chat-ui-menu-open-button = #
nano-chat-ui-menu-open-button-unread = # ({ $unread })
nano-chat-ui-menu-open-button-tooltip = Открыть меню

nano-chat-ui-menu-options-contacts = Контакты
nano-chat-ui-menu-options-group-chats = Групповые чаты
nano-chat-ui-menu-options-tooltip = Выбор меню


nano-chat-ui-contacts-input-search-field = Поиск...
...
nano-chat-ui-chat-window-notification-tooltip = Переключить уведомления
...
nano-chat-ui-chat-window-sender-server = Сервер
