...
vampire-selecting-window-subgroupHemomancer-text =
    ...
    {"["}bold]Воздушный побег[/bold]: Разблокируется на 100 крови. Призывает рой атакующих летучих мышей и превращает вампира в летучую мышь на 10 секунд.

    {"["}bold]Кровавое перевоплощение[/bold]: Разблокируется на 200 крови. На 4 секунды превращает вас в кровь, позволяя проходить сквозь препятствия.

    {"["}bold]Гнев Носферату[/bold]: Разблокируется на 350 крови. На 25 секунд: в 2 раза больше урона, +50% скорости атаки, +50% скорости передвижения.

vampire-selecting-window-subgroupUmbrae-text =
    {"["}bold]Свобода[/bold]: Разблокируется на 100 крови. Разрывает наручники и увеличивает скорость в 1.5 раза на 10 секунд.

    {"["}bold]Переключить режим невидимости[/bold]: Разблокируется на 100 крови. Делает вампира невидимым за счёт 2 ед. крови в секунду. Любая атака/урон прерывает эффект.

    {"["}bold]Кровавый якорь[/bold]: Разблокируется на 200 крови. Создает якорь в точке активации. При повторном нажатии телепортирует к себе. Якорь исчезает через 2 минуты или после использования.

    {"["}bold]Теневой капкан[/bold]: Разблокируется на 200 крови. Устанавливает полу-невидимую ловушку. При срабатывании ослепляет жертву и наносит 20 урона.

    {"["}bold]Клон[/bold]: Разблокируется на 350 крови. Создаёт вашу копию, отвлекающую экипаж, пока вы в невидимости покидаете место боя.

vampire-selecting-window-subgroupGargantua-text =
    {"["}bold]Прилив крови[/bold]: Разблокируется на 100 крови. Увеличивает скорость передвижения в 2.5 раза на 10 секунд.

    {"["}bold]Вампирский скачок[/bold]: Разблокируется на 200 крови. Телепортирует на короткую дистанцию, оставляя облако дыма на месте отправления.

    {"["}bold]Сверк[/bold]: Разблокируется на 200 крови. Ослепляющая вспышка в радиусе 3 тайлов, оглушающая всех жертв и полностью истощающая их выносливость.

    {"["}bold]Гнев Носферату[/bold]: Разблокируется на 300 крови. На 25 секунд: в 2 раза больше урона, +50% скорости атаки, +50% скорости передвижения.

    {"["}bold]Рывок[/bold]: Разблокируется на 350 крови. Вы кидаетесь в сторону, куда нажали. Если вы попадёте в человека, вы оглушите его. Если попадёте в предмет, то он получит 200 ед урона.

vampire-selecting-window-subgroupHemomancer-turn = [bold]Обращение[/bold]: Разблокируется на 450 крови. Катана становится вечной: она больше не имеет ограничения по времени и не исчезает после использования.

vampire-selecting-window-subgroupUmbrae-turn = [bold]Обращение[/bold]: Разблокируется на 400 крови. Способность "Переключить режим невидимости" больше не расходует кровь при активации и поддержании.

vampire-selecting-window-subgroupGargantua-turn = [bold]Обращение[/bold]: Разблокируется на 400 крови. Гнев Носферату активируется без затрат крови. Кулдаун между использованиями: 10 секунд.
...
vampire-popup-warning-turning-blood = Вы не можете стать лужей крови под действием бафф способностей!
...
vampire-popup-target-no-mind = Жертва без разума - её кровь утоляет жажду, но не даёт силы
vampire-popup-target-no-mind-full = Вы уже сыты, а для получения сил жертва должна иметь разум!
vampire-popup-max-number-ghouls = Максимальное количество рабов уже достигнуто
...
vampire-popup-chaplain-closely = Присутствие святого причиняет вам боль!
