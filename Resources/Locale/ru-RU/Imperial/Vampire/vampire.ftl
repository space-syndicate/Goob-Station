...
vampire-selecting-window-subgroupUmbrae-text =
    ...
    {"["}bold]Клон[/bold]: Разблокируется на 300 крови. Создаёт вашу копию, отвлекающую экипаж, пока вы в невидимости покидаете место боя.

    {"["}bold]Свобода[/bold]: Разблокируется на 400 крови. Разрывает наручники и увеличивает скорость в 1.5 раза на 10 секунд.
...
vampire-selecting-window-subgroupGargantua-text =
    ...
    {"["}bold]Свобода[/bold]: Разблокируется на 300 крови. Разрывает наручники и увеличивает скорость в 1.5 раза на 10 секунд.

    {"["}bold]Гнев Носферату[/bold]: Разблокируется на 400 крови. На 25 секунд: в 2 раза больше урона, +50% скорости атаки, +50% скорости передвижения.

vampire-selecting-window-subgroupHemomancer-turn = [bold]Обращение[/bold]: Разблокируется на 500 крови. Коготь становится вечным: он больше не имеет ограничения по времени и не исчезает после использования.
