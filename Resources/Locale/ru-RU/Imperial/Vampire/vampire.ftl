...
vampire-selecting-window-subgroupHemomancer-turn = [bold]Обращение[/bold]: Разблокируется на 500 крови. Коготь становится вечным и не имеет ограничения по времени. Кулдаун при переключении: 20 секунд.
