...
ent-ActionToggleInjection = Переключить отсек ЭП
    .desc = Переключает отсек экстренной помощи
ent-hardsuitinjection-injection = Ввод веществ из отсека ЭП
    .desc = Вводит вещества из ампулы содержащейся в отсеке экстренной помощи
