...
language-Hydraspeak-description = Смесь из пения, дрожания и чириканья, вместе с резкой смены тональности и высоты звука делают этот язык необычным. В силу своей птичьей натуры гидракинов, одно слово может значить много вещей одновременно, что делает этот язык крайне непонятным даже для других птицеподобных рас.
