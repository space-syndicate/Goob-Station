...
ent-BaseReactorGasChannel = стержень газового канала
    .desc = Стержень газового канала для ядерного реактора.
...
ent-PlasmaGlassReactorGasChannel = плазменностеклянный стержень газового канала
    .desc = { ent-BaseReactorGasChannel.desc }
...
ent-BaseNuclearReactor = ядерный реактор
    .desc = Корпус ядерного реактора со слотами для топливных стержней и других компонентов. Подождите, один из них разве не взрывался?
...
ent-IngotPlutonium = слиток плутония
    .suffix = Полный
