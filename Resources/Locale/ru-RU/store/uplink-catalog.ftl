...
uplink-hijack-beacon-desc = Устройство синдиката, позволяющее обходить брандмауэр на Торговых Аванпостах Nanotrasen. Занимает 200 секунд для работы, об угоне будут знать все - приготовьтесь к драке.
