# Успешные действия при поглаживании
...
petting-failure-station-ai = Вы протягиваете руку, чтобы погладить { THE($target) }, но { SUBJECT($target) } { CONJUGATE-BASIC($target, "бац", "бах") } вы убираете свою руку.
