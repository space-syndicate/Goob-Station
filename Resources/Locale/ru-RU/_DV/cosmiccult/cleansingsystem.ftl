cleanse-deconvert-attempt-begin = { CAPITALIZE($target) } протягивает вам розарий!
cleanse-deconvert-attempt-begin-user = Вы пытаетесь очистить { CAPITALIZE($target) } от потустороннего влияния!
cleanse-deconvert-attempt-success = Вы очищаете { CAPITALIZE($target) } в вспышке святого света!
