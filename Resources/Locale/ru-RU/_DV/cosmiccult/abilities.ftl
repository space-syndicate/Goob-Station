...
cosmicability-siphon-crit = Глаза { CAPITALIZE(THE($user)) } вспыхивают энергией и { THE($target) } падает замертво!
cosmicability-hibernate-confirm = ЭТО ДЕЙСТВИЕ ПРИКРЕПИТ ВАС К ЭТОМУ МЕСТУ! Используйте его снова для подтверждения.
