...
ent-ActionSpawnWallResinThick = Построить крепкую смоляную стену (400)
    .desc = Выделяет очень прочную податливую смолу.
ent-ActionSpawnResinDoorThick = Построить крепкую смоляную дверь (250)
    .desc = Выделяет очень прочную податливую смолу.
