...
ent-WeaponCrusherHammer = молот-крушитель
    .desc = Мощное двуручное оружие, которое наносит отдачу и более тяжёлый урон, чем крушитель.
ent-WeaponCrusherHalberd = алебарда-крушитель
    .desc = Универсальное оружие, сочетающее силу крушителя и дальность копья.
