...
ent-ResearchAndDevelopmentServerMachineFlatpack = R&D server flat pack
    .desc = A flatpack used for constructing an R&D server.
ent-ResearchComputerFlatpack = R&D computer flat pack
    .desc = A flatpack used for constructing an R&D computer.
ent-MaterialSiloFlatpack = material silo flat pack
