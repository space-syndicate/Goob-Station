...
ent-ClothingOuterDavidsJacketValid = Куртка на грани
    .desc = Куртка с высоким воротником. Изготовлена из многослойного синтетического материала и помогает контролировать киберимпланты. Глядя на неё, почему-то хочется полететь на Луну...
