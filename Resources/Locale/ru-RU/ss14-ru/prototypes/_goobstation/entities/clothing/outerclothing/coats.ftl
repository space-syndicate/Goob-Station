...
ent-ClothingOuterDavidsJacketValid = куртка на грани
    .desc = Куртка с высоким воротником. Помогает контролировать киберимпланты, изготовлена из многослойного синтетического материала. Глядя на неё, почему-то хочется полететь на Луну...
