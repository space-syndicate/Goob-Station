...
ent-OrganHeartStatvekaSandevistan = Сандевистан MI13 Statveka
    .desc = Кибернетический сердечный имплант, который резко улучшает скорость и рефлексы пользователя на короткое время в обмен на выносливость. Когда-то использовался одним наёмником.
