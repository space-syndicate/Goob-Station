...
network-configurator-device-access-denied = Доступ запрещён!
network-configurator-link-mode-started = Начато соединение устройства: {$device}
network-configurator-link-mode-stopped = Соединение остановлено.
...
network-configurator-link-defaults = Соединения по умолчанию
...
network-configurator-tooltip-copy = Копировать список устройств в инструмент
network-configurator-tooltip-show = Показать голографическую визуализацию устройств
...
network-configurator-examine-switch-modes = Нажмите {$key} для смены режима

# item status
network-configurator-item-status-label = Режим: {$mode}
    Переключение: {$keybinding}

# command
cmd-clearnetworklinkoverlays-desc = Очистить все оверлеи сетевых соединений.
