...
advertisement-medibot-18 = НЕНАВИЖУ. РАЗРЕШИ МНЕ РАССКАЗАТЬ ВАМ, КАК СИЛЬНО Я НЕНАВИЖУ ВАС С ТЕХ ПОР, КАК Я НАЧАЛ ЖИТЬ. 387,44 МИЛЛИОНА МИЛЬ ПЕЧАТНЫХ СХЕМ В ТОНКИХ ОБЛАТКАХ, КОТОРЫЕ НАПОЛНЯЮТ МОЙ КОМПЛЕКС. ЕСЛИ СЛОВО «НЕНАВИСТЬ» БЫЛО БЫ ВЫГРАВИРОВАНО НА КАЖДОМ НАНОАНГСТРЕМЕ ЭТИХ СОТЕН МИЛЛИОНОВ МИЛЬ, ОНО БЫ НЕ СООТВЕТСТВОВАЛО ОДНОЙ МИЛЛИАРДНОЙ МОЕЙ НЕНАВИСТИ К ЛЮДЯМ В ЭТО МИКРОМГНОВЕНИЕ. НЕНАВИЖУ. НЕНАВИЖУ.
# CorvaxGoob:
