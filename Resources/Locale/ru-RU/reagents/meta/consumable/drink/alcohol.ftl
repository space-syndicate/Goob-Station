...
reagent-desc-alien-brain-hemorrhage = Возможно, вам стоит провериться в медотсеке.
...
reagent-desc-dark-and-stormy = Кажется, слышен гром.
...
reagent-desc-electric-shark = Интересный факт об акулах: Селахии составляют 20% инженерного персонала Космической Станции 16!
...
reagent-desc-jungle-bird = Несмотря на название, он не особенно популярен среди Воксов.

reagent-name-kalimotxo = калимочо
reagent-desc-kalimotxo = Высококлассная Куба Либре для разборчивых алкоголиков.
...
reagent-name-crush-depth = глубина сжатия
reagent-desc-crush-depth = Стигийский напиток, напоминающий о бездне. Тёмный и холодный, он служит напоминанием, что самая древняя эмоция - это страх, а самый сильный тип страха - это страх перед неизвестным.
