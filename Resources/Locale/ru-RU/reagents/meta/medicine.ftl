...
reagent-desc-warfarin = Обычно используется как антикоагулянтное средство. Затрудняет свёртывание крови. При передозировке может вызвать внутреннее кровотечение.
