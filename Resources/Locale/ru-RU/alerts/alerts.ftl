...
alerts-rooted-name = Сломленный
alerts-rooted-desc = Вы прибиты к земле. Вы не можете поскользнуться, но вы впитываете жидкости под собой.

alerts-stealthy-name = Карманная кража
alerts-stealthy-desc = Если вы в данный момент занимаетесь карманной кражей, нажмите, чтобы переключиться (Это скроет от других игроков, что вы делаете).

alerts-prying-name = Вскрытие
alerts-prying-desc = Вы можете вскрывать шлюзы с помощью альтернативного взаимодействия.
