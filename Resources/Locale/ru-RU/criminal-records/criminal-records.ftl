...
criminal-records-console-no-record-found = Не найдено записей о выбранном сотруднике.
...
criminal-records-history-placeholder = Введите преступление здесь
criminal-records-no-history = У этого члена экипажа безупречная репутация.
