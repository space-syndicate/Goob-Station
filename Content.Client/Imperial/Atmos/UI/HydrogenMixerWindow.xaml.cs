...
namespace Content.Client.Imperial.Atmos.UI
{
    ...
    public sealed partial class HydrogenMixerWindow : DefaultWindow
    {
        ...
        public HydrogenMixerWindow()
        {
            ...
            {
                MixerPressureOutputInput.Text = Atmospherics.HydrogenMaxOutputPressure.ToString(CultureInfo.CurrentCulture);
