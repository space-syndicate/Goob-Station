...
public sealed partial class PumpControl : BoxContainer
{
    ...
    public PumpControl(GasVentPumpData data, string address)
    {
        ...
        {
            _pumpDirection.AddItem(Loc.GetString($"air-alarm-ui-pump-direction-{value.ToString().ToLower()}"), (int) value);  // Imperial Space Translation
        }
        ...
        {
            _pressureCheck.AddItem(Loc.GetString($"air-alarm-ui-pressure-bound-{value.ToString().ToLower()}"), (int) value);  // Imperial Space Translation
        }
