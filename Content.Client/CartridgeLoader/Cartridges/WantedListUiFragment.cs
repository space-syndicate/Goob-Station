...
using Content.Shared.Humanoid.Prototypes; // CorvaxGoob-Locale
...
public sealed partial class WantedListUiFragment : BoxContainer
{
    ...
    private void OnItemSelected(BaseButton.ButtonEventArgs args, ListData data)
    {
        ...
        TargetSpecies.SetMessage(GetLoc(
            ...
            ("species", Loc.GetString(_prototypeManager.Index<SpeciesPrototype>(record.TargetInfo.Species).Name).ToLower()) // CorvaxGoob-Locale
        ));
